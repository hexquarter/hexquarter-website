    ...
    return (
        <div id="stack" className="lg:px-20 px-5 py-20 border-muted-foreground/30 border-b-1 flex flex-col gap-10">
            ...
            <div className="grid lg:grid-cols-2 2xl:grid-cols-4 w-full ">
                <div className="border-1 border-muted-foreground/20 p-5 2xl:p-10 flex group flex-col gap-7 border-t-1 hover:border-t-primary hover:border-t-3 hover:bg-white">
                    <div className="flex flex-col gap-2">
                    ...
                    <div className="grid grid-cols grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div className="border-1 border-muted-foreground/20 p-5 2xl:p-10 flex group flex-col gap-3 border-t-1 hover:border-t-primary hover:border-t-3 hover:bg-white">
                    <div className="flex flex-col gap-2">
