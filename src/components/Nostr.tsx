...
export const Nostr = () => {
    return (
        <div id="nostr" className="lg:px-20 px-5 py-20">
            <div className="flex flex-col lg:gap-10">
                <div className="flex lg:flex-row flex-col justify-between gap-10">
                    <div className="flex-1 flex flex-col gap-10">
                        <h3 className="font-mono uppecase tracking-widest uppercase text-sm text-muted-foreground font-lighter text-violet-400/80">Nostr expertise</h3>
